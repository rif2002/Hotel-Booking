        ...
        <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10  '>
            ...
            <div>
                ...
                <div className='w-full mt-4 max-w-60 mr-auto'>
                    <label htmlFor="city" className='font-medium text-grey-500'>City</label>
                ...
                <button className='bg-indigo-500 text-white rounded px-6 py-2 mt-6 mr-auto hover:bg-indigo-600 transition-all'>Register</button>
            </div>
        </div>
      </form>
    </div>
