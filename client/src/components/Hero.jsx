...
function Hero() {
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32  text-white bg-[url("/src/assets/heroImage.png")] bg-cover bg-no-repeat bg-center h-screen'>
      ...
      <p className='text-sm md:text-base mt-4 max-w-2xl'>Explore a world of luxury and comfort with our handpicked hotels, designed to make your stay unforgettable.</p>
