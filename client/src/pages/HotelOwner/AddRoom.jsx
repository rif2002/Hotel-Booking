...
function AddRoom() {
  ...
  return (
    <form>
        <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the details carefully and accurate room details, pricing, and amenities to enhance use booking experience.' />
        ...
        <button className='bg-primary tet-white px-8 p-2 rounded mt-8 cursor-pointer'>Add Room</button>
    </form>
  )
}
