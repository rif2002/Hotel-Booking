...
function AllRooms() {
    ...
    const roomTypes = ['Single Bed', 
        'Double Bed', 
        'Luxury Room', 
        'Family Suite'];
    
    const priceRanges = [ '0 to 500',
    '500 to 1000',
    '1000 to 2000',
    '2000 to 3000',
    ];
    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2 max-w-174'>Explore our selection of hotel rooms, each designed for comfort and relaxation.</p>
            </div>
                ...
                {roomsDummyData.map((room, index) => (
                    <div  key={room._id}  className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                        ...
                        <div className='md:1/2 flex flex-col gap-2 '>
                            ...
                            <p onClick={()=>{navigate(`/rooms/${room._id}`); scrollTo(0,0)}} className='font-playfair text-xl font-medium text-grey-800 cursor-pointer'>{room.hotel.name}</p>
        ...
        <div className='bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16'>
            <div className={`flex items-center justify-between px-5 py-2.5 min-1g:border-b border-gray-300 ${openFilter && "border-b"}`}>
